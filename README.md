...
[video.webm](https://github.com/user-attachments/assets/01c57e4e-0a30-4940-8c09-c0de47d20b10)
...
Сенсорная панель ZIGBEE в режиме координатора с возможностью формирования сети, добавления устройств, настройки связей, мониторинга состояний и управления. На данном этапе подразумевается поддержка кластеров температуры, влажности, IAS Zone и on/off
