...
ui_TopPanelForSensorsWidget_buttons_t* TopPanelForSensorsWidget_buttonsCreate(lv_obj_t* parent, uint8_t parentScreenGlobalIndex)
{
    ...
    {
        ui_TopPanelForSensorsWidget_buttons_t* btns_obj = NULL;
        btns_obj = calloc(1, sizeof(ui_TopPanelForSensorsWidget_buttons_t));
        if (btns_obj == NULL) 
        {
            lvgl_port_unlock();
            return NULL;
...
ui_ScreenTopPanelObject_t* ScreenTopPanelObjectCreate(lv_obj_t* parent, top_panel_type_t panel_type, uint8_t parentScreenGlobalIndex)
{
    if (lvgl_port_lock(0) == true)
    {
        ...
        {
            panel_obj->top_panel_buttons = TopPanelForSensorsWidget_buttonsCreate(panel_obj->on_create_elements_array[0], panel_obj->parentScreenGlobalIndex);
...
ui_ScreenMainPanelObject_t* ScreenMainPanelObjectCreate(lv_obj_t* parent, main_panel_type_t panel_type, uint8_t parentScreenGlobalIndex)
{
    if (lvgl_port_lock(0) == true)
    {
        ...
        {
            panel_obj->top_panel_obj_pointer = ScreenTopPanelObjectCreate(panel_obj->on_create_elements_array[0], TOP_PANEL_FOR_SENSORS_WIDGET_SHOW, panel_obj->parentScreenGlobalIndex);
            panel_obj->buttons_for_sensor_widget_show_screen = MainPanelForSensorsWidget_buttonsContainerCreate(panel_obj->on_create_elements_array[0],panel_obj->parentScreenGlobalIndex);
