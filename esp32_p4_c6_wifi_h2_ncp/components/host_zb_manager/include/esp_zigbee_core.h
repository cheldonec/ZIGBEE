...
#ifndef __ESP_ZIGBEE_CORE_H__
#define __ESP_ZIGBEE_CORE_H__
//#endif
 ...
 * @note Must be called after esp_zb_init() and esp_zb_start() inside the application's main cycle.
 *
 */
__attribute__((deprecated)) void esp_zb_main_loop_iteration(void);
